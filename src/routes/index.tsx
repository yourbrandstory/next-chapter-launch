...
function Logo({ light = false }: { light?: boolean }) {
  return (
    <div className="flex items-center gap-2.5">
      <span
        className={`relative grid h-8 w-8 place-items-center rounded-full ${light ? "bg-white" : "bg-ink"}`}
      >
        <span
      ...
      <div className="flex flex-col gap-[3px]">
        <span className={`serif text-[24px] leading-none ${light ? "text-white" : "text-ink"}`}>
          TeamMap
        </span>
        <span
          className="text-[10.5px] font-medium uppercase tracking-[.14em] leading-none"
          style={{ color: light ? "rgba(255,255,255,0.6)" : "#5a5a5a" }}
        >
          By Next Chapter
        </span>
      </div>
      ...
      <div ref={menuRef} className="mx-auto max-w-7xl px-5 py-4 sm:px-8">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-[14px] text-sub">
            <a href="#built-for" className="hover:text-ink transition-colors">
              Who it's for
            </a>
            <a href="#how" className="hover:text-ink transition-colors">
              How it works
            </a>
            <a href="#inside" className="hover:text-ink transition-colors">
              What you get
            </a>
            <a href="#stories" className="hover:text-ink transition-colors">
              Stories
            </a>
          </nav>
          ...
          >
            <span className="flex flex-col gap-1">
              <span
                className={`block h-0.5 w-5 bg-current transition-transform duration-200 ${menuOpen ? "translate-y-1.5 rotate-45" : ""}`}
              />
              <span
        ...
        >
          <nav className="flex flex-col gap-3 border-t border-hairline pt-4 pb-2">
            <a
              href="#built-for"
              onClick={closeMenu}
              className="rounded-lg px-4 py-3 text-[15px] text-sub hover:bg-alt hover:text-ink transition-colors"
            >
              Who it's for
            </a>
            <a
          ...
          <div key={m.name} className="rounded-xl border border-hairline p-3">
            <div className="flex items-center justify-between">
              ...
              <span
                ...
                style={{ background: "var(--alt)", color: m.c }}
              >
                {m.mood}
              </span>
            </div>
            <div className="mt-2 h-1.5 w-full rounded-full bg-hairline overflow-hidden">
              <div
                ...
                style={{ width: `${m.load}%`, background: m.c }}
              />
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-2 shrink-0">
              ...
              <span
                ...
                style={{ background: "var(--alt)", color: r.c }}
              >
                {r.tag}
              </span>
            </div>
...
function Hero() {
  ...
  return (
    <section id="top" className="relative overflow-x-clip">
      <div
        aria-hidden
        className="absolute inset-0 dot-grid opacity-60 [mask-image:radial-gradient(ellipse_at_center,black,transparent_75%)]"
      />
      <div
        aria-hidden
        className="glow-blob h-[clamp(240px,50vw,420px)] w-[clamp(240px,50vw,420px)] -left-[clamp(60px,12vw,128px)] top-10 opacity-70"
      />
      <div
        aria-hidden
        className="glow-blob h-[clamp(200px,40vw,360px)] w-[clamp(200px,40vw,360px)] -right-[clamp(40px,10vw,100px)] top-40 opacity-60"
      />
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-8 px-5 pt-14 pb-24 sm:px-8 lg:grid-cols-[1.05fr_1fr] lg:gap-16 lg:pt-20 lg:pb-32">
        <div>
          ...
          <p
            className="reveal mt-6 max-w-xl text-[clamp(15px,2.2vw,17px)] leading-relaxed text-sub"
            style={{ transitionDelay: "0.08s" }}
          >
            A custom-built team management system, designed around the way you actually work — not
            the way some SaaS product assumes you do.
          </p>
          <div
          ...
          <p
            className="reveal mt-5 text-[clamp(11px,2vw,12px)] text-sub"
        ...
        <div className="reveal-scale relative mx-auto w-full max-w-md sm:max-w-none">
          <div
            className="absolute -inset-4 sm:-inset-6 -z-10 rounded-[36px]"
            style={{
          ...
          <div className="absolute -right-2 sm:-right-6 top-20 sm:top-24 hidden sm:block card-soft p-2.5 sm:p-3 text-[clamp(10px,2vw,11px)] rotate-[6deg] animate-float">
            ...
            <div className="flex flex-col gap-1 text-sub">
              ...
              <span>
                <i className="inline-block h-2 w-2 rounded-full mr-1.5 bg-emerald-500" />
                In motion
              </span>
              <span>
                <i className="inline-block h-2 w-2 rounded-full mr-1.5 bg-amber-500" />
                Waiting
              </span>
            </div>
          </div>
          <div className="absolute -bottom-4 sm:-bottom-5 left-4 sm:left-10 rounded-2xl bg-ink px-3 py-2.5 sm:px-4 sm:py-3 text-white shadow-soft">
            <div className="text-[clamp(9px,1.6vw,10px)] uppercase tracking-widest text-white/60">
              Productivity
            </div>
            <div className="serif text-[clamp(18px,3.5vw,22px)] leading-none">
              3× <span style={{ color: "var(--accent)" }}>faster</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="relative mt-6 overflow-hidden">
        ...
        <div className="flex w-max animate-marquee gap-12 pr-12">
          {row.map((w, i) => (
            <span
              key={i}
              className="serif text-[clamp(2rem,4vw,3.4rem)] text-ink/30 italic whitespace-nowrap"
            >
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div className="grid items-end gap-10 md:grid-cols-2">
          ...
          <p className="reveal text-[17px] text-sub md:pb-3" style={{ transitionDelay: "0.08s" }}>
            Three kinds of leader, one recurring problem: the work is real, but the system holding
            it together is you. Task Manager 2.0 takes that weight off your shoulders.
          </p>
        </div>
        ...
        <div className="mt-10 sm:mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {cards.map((c, i) => (
            ...
            >
              <div
                className="absolute -top-16 -right-16 w-36 h-36 rounded-full pointer-events-none opacity-30"
                style={{
              ...
              <div className="flex items-start justify-between mb-5">
                ...
                <span className="founder-index serif" style={{ color: `${c.accent}25` }}>
                  {c.index}
                </span>
              </div>
              <h3 className="serif text-[clamp(20px,3vw,24px)] text-ink">{c.title}</h3>
              <div className="founder-subtitle" style={{ color: c.accent }}>
                {c.subtitle}
              </div>
              <p className="mt-3 text-[clamp(14px,2vw,14.5px)] leading-relaxed text-sub">
                {c.desc}
              </p>
              <div className="mt-auto">
                ...
                <div className="flex items-center gap-2 pt-4">
                  ...
                  >
                    <Users className="h-3.5 w-3.5 mr-1.5" strokeWidth={2} />
                    {c.size}
                  </span>
                  <span className="founder-arrow" style={{ color: c.accent }}>
                    →
                  </span>
                </div>
              </div>
...
function ScreenCard({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="flex h-full w-full flex-col card-soft overflow-hidden p-4">
...
function Coverflow() {
  const screens = [
    { title: "TeamMap — Task Dashboard", src: "/images/ss1.jpeg" },
    { title: "Sticky Notes Board", src: "/images/ss2.jpeg" },
    { title: "New Task", src: "/images/ss3.jpeg" },
    { title: "Task Modal", src: "/images/ss4.jpeg" },
  ];
  ...
  function resetTimer() {
    ...
    timerRef.current = setInterval(() => setIdx((i) => (i + 1) % n), 3500);
  }
    ...
    >
          ...
          return (
            <button
              ...
              style={{
                ...
                transform: `translate(-50%,-50%) translateX(${d * spread}%) scale(${Math.max(0.8, 1 - ad * 0.1)})`,
                filter: ad ? `blur(${ad * 1.2}px)` : "none",
                opacity: ad ? Math.max(0.45, 0.8 - (ad - 1) * 0.28) : 1,
                zIndex: 30 - ad * 10,
                boxShadow: ad
                  ? "0 24px 50px -30px rgba(0,0,0,.4)"
                  : "0 50px 100px -38px rgba(0,0,0,.55), 0 0 0 1px rgba(0,0,0,.04)",
                transition: "transform .6s cubic-bezier(.3,.7,.3,1), filter .6s, opacity .6s",
              }}
            >
              <ScreenCard title={s.title}>
                <img src={s.src} alt={s.title} className="h-full w-full rounded-md object-cover" />
              </ScreenCard>
            </button>
          );
        })}
      ...
      <div className="mt-6 flex justify-center gap-3">
        <button
          onClick={() => go(-1)}
          aria-label="Previous"
          className="touch-btn grid h-11 w-11 sm:h-10 sm:w-10 place-items-center rounded-full border border-hairline bg-paper hover:border-ink"
        >
...
function Surgical() {
  ...
  return (
    <section className="bg-alt border-b border-hairline overflow-x-hidden">
      <div className="mx-auto max-w-7xl px-5 section-pad sm:px-8">
        <div className="max-w-3xl">
          ...
          <h2 className="reveal mt-3 section-h">
            Every task. Every teammate. <em className="italic">One place.</em>
          </h2>
        </div>

        <div className="reveal-scale mt-8 sm:mt-10">
          <Coverflow />
        </div>
        <div className="mt-12 sm:mt-20 grid gap-6 sm:grid-cols-2">
          ...
          <div
            ...
            style={{
              ...
              boxShadow: "0 0 0 1px var(--accent), var(--shadow-glow), var(--shadow-soft)",
            }}
          >
            <div className="eyebrow" style={{ color: "var(--accent-deep)" }}>
              With Task Manager 2.0
            </div>
            <ul className="mt-5 space-y-3.5">
              {after.map((b) => (
                <li key={b} className="flex gap-3 text-[15px] text-ink">
                  <span
                    ...
                    style={{ background: "var(--wash)", color: "var(--accent-deep)" }}
                  >
  ...
  const items = [
    {
      eb: "Views",
      title: "Custom views",
      desc: "Task Dashboard, Line Up, List View, Task Generator — each shaped to a different decision.",
    ...
    },
    {
      ...
      desc: "Daily, Weekly, 15th-of-month, Pre-Event — recurring work fires itself.",
      icon: Repeat,
      c: "#10b981",
    },
    {
      ...
      desc: "Mood tags Top, Hero, Imp, Rapid — language your team already speaks.",
      icon: Flag,
      c: "#f59e0b",
    },
    {
      eb: "Taxonomy",
      title: "Master tags",
      desc: "A single source of truth for projects, clients, and themes across the company.",
      icon: Tags,
      c: "#a855f7",
    },
    {
      eb: "North star",
      title: "Milestones",
      desc: "Tie daily tasks to the quarterly thing that actually matters.",
      icon: Target,
      c: "#e76f51",
    },
    {
      eb: "Speed",
      title: "Built with AI",
      desc: "Deployed in days, not months. Iterated in hours, not sprints.",
      icon: Sparkles,
      c: "#000000",
    },
  ];
      ...
      <div className="mx-auto max-w-7xl px-5 section-pad sm:px-8">
        ...
        <div className="mt-14 grid gap-px overflow-hidden rounded-[22px] border border-hairline bg-hairline sm:grid-cols-2 lg:grid-cols-3">
          {items.map((it, i) => (
            <div
              key={it.title}
              className="reveal bg-paper p-6 sm:p-8 transition-colors hover:bg-alt"
              style={{ transitionDelay: `${(i % 3) * 0.06}s` }}
            >
              <div
                className="grid h-11 w-11 place-items-center rounded-xl text-white"
                style={{ background: it.c, boxShadow: `0 8px 24px -10px ${it.c}55` }}
              >
    ...
    <section className="bg-paper border-b border-hairline">
      <div className="mx-auto max-w-7xl px-5 section-pad sm:px-8">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <StatCard
            light
            eyebrow="Task completion visibility"
            value={
              <>
                <Counter to={50} suffix="%+" />
              </>
            }
            label="improvement in task completion visibility"
            percent={70}
          />
          <StatCard
            light
            ...
            label="lift in team output, week over week"
            percent={88}
          />
          <StatCard
            eyebrow="Time saved"
            value={
              <>
                <Counter to={45} suffix="m" />
              </>
            }
            label="saved daily on check-ins and pings"
            percent={62}
          />
        </div>
      </div>
...
function StatCard({
  ...
  return (
    ...
    >
      ...
      <div
        className={`serif mt-3 text-[clamp(3rem,6vw,4.4rem)] leading-none ${light ? "" : ""}`}
...
function Timeline() {
  const steps = [
    {
      n: "01",
      t: "Discovery questionnaire",
      d: "We learn how your team really works — the tools, the friction, the non-negotiables.",
      tag: "60 minutes",
    },
    {
      n: "02",
      t: "Workstyle brainstorm",
      d: "A working session with your team to surface the priority language and routines they need.",
      tag: "With your team",
    },
    {
      n: "03",
      t: "Phase 1 deployment",
      d: "First working version in your hands, with the core workflows wired up.",
      tag: "Fast deployment",
    },
    {
      n: "04",
      t: "Run it for a week",
      d: "Your team uses it for real work. We watch where it bends and where it breaks.",
      tag: "Your feedback",
    },
    {
      n: "05",
      t: "Iteration and refinement",
      d: "We translate that week of feedback into surfaces, fields, and routines that fit.",
      tag: "We do the work",
    },
    {
      n: "06",
      t: "Cloud deployment — it's yours",
      d: "Production deployment with documentation and a support cadence that keeps it evolving.",
      tag: "Ongoing support",
      done: true,
    },
  ];
                  ...
                  style={
                    s.done
                      ? {
                          ...
                          borderColor: "var(--accent)",
                          boxShadow: "0 0 0 4px rgba(0,212,255,0.18)",
                        }
...
function Avatar({ name, gradient }: { name: string; gradient: string }) {
  ...
  return (
    <div
      className="grid h-12 w-12 place-items-center rounded-full text-white font-semibold text-[14px]"
...
function Testimonials() {
  const quotes = [
    {
      name: "Rohan Iyer",
      role: "Founder, Pixelclub Agency",
      g: "linear-gradient(135deg,#a855f7,#6366f1)",
      quote:
        "Recurring tasks used to slip through every week. Now the templates fire themselves. Easily 45 minutes back daily.",
    },
    {
      name: "Aayushi",
      role: "Manager, Your Brand Story",
      g: "linear-gradient(135deg,#0d9488,#14b8a6)",
      quote:
        "The task dashboard finally gives me a real-time view of what everyone's working on. No more status-check messages — I just look at the board.",
    },
    {
      name: "Aasha",
      role: "Designer, Your Brand Story",
      g: "linear-gradient(135deg,#f43f5e,#e11d48)",
      quote:
        "Having a shared priority system means our design reviews actually start on time. The team knows what's Top vs. what can wait.",
    },
  ];
...
function FinalCTA() {
  ...
  return (
    <section className="relative bg-paper overflow-hidden">
      <div
        aria-hidden
        className="glow-blob h-[600px] w-[600px] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 opacity-80"
      />
      <div className="relative mx-auto max-w-3xl px-5 section-pad text-center">
        ...
        <p className="reveal mt-6 text-[17px] text-sub" style={{ transitionDelay: "0.08s" }}>
          Book a 60-minute discovery call. We'll map your team's workflow, show you what Task
          Manager 2.0 could look like for you, and tell you honestly if it's a fit.
        </p>
      ...
      <div className="mx-auto max-w-7xl px-5 section-pad sm:px-8 grid gap-10 sm:gap-14 sm:grid-cols-2 lg:grid-cols-[1.2fr_1fr_1fr]">
        <div>
          ...
          <p className="serif mt-5 max-w-sm text-[22px] leading-snug text-white/85">
            Making businesses easier to run —{" "}
            <em className="italic">one custom system at a time.</em>
          </p>
          <div className="mt-7 flex gap-3">
            {[
              ...
              <a
                ...
                href={href}
                aria-label={label}
                className="grid h-10 w-10 place-items-center rounded-full border border-white/20 hover:border-white hover:bg-white/5 transition-colors"
              >
        ...
        <div>
          ...
          <p className="mt-3 text-[14px] text-white/70">
            One short read each month on building systems your team actually uses.
          </p>
          <form
            onSubmit={(e) => {
              e.preventDefault();
        ...
        <div>
          ...
          <a
            ...
            className="mt-3 block serif text-[22px] hover:opacity-80"
          >
            hello@nextchapter.in
          </a>
